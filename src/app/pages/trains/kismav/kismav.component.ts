...
@Component({
  selector: 'app-kismav',
  templateUrl: './kismav.component.html',
  styleUrls: ['./kismav.component.scss']
})
export class KismavComponent {
  @ViewChild('kismav', { static: true }) myCanvas !: ElementRef;
  ...
  createThreeJsTrain(): void {
    ...
    var light1;
    var url = '../../../../../assets/blender/kismav.obj';
    var mtl = '../../../../../assets/blender/kismav.mtl';
    var mesh: THREE.MeshStandardMaterial;
    var valami: any;
    var controls: OrbitControls;

    const canvas = document.getElementById('kismav');
