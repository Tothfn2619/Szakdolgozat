...
@Component({
  selector: 'app-harmincharom',
  templateUrl: './harmincharom.component.html',
  styleUrls: ['./harmincharom.component.scss']
})
export class HarmincharomComponent {


  @ViewChild('33', { static: true }) myCanvas !: ElementRef;
  ...
  createThreeJsTrain(): void {
    ...
    var light1;
    var url = '../../../../../assets/blender/33.obj';
    var mtl = '../../../../../assets/blender/33.mtl';
    var mesh: THREE.MeshStandardMaterial;
    var valami: any;
    var controls: OrbitControls;

    const canvas = document.getElementById('33');
