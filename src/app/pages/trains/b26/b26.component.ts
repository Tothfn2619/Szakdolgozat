...
@Component({
  ...
  styleUrls: ['./b26.component.scss']
})
export class B26Component {

  @ViewChild('b26', { static: true }) myCanvas !: ElementRef;
  ...
  createThreeJsTrain(): void {
    ...
    var light1;
    var url = '../../../../../assets/blender/b26.obj';
    var mtl = '../../../../../assets/blender/b26.mtl';
    var mesh: THREE.MeshStandardMaterial;
    var valami: any;
    var controls: OrbitControls;

    const canvas = document.getElementById('b26');
