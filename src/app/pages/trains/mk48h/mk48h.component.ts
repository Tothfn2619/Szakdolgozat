...
@Component({
  selector: 'app-mk48h',
  templateUrl: './mk48h.component.html',
  styleUrls: ['./mk48h.component.scss']
})
export class Mk48hComponent {
  @ViewChild('mk48h', {static: true}) myCanvas !: ElementRef;
  ...
  createThreeJsTrain(): void {
    ...
    var light1;
    var url = '../../../../../assets/blender/mk48hibrid.obj';
    var mtl = '../../../../../assets/blender/mk48hibrid.mtl';
    var mesh : THREE.MeshStandardMaterial;
    var valami: any;
    var controls: OrbitControls;
   
    const canvas = document.getElementById('mk48h');
