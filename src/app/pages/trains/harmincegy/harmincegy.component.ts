...
@Component({
  selector: 'app-harmincegy',
  templateUrl: './harmincegy.component.html',
  styleUrls: ['./harmincegy.component.scss']
})
export class HarmincegyComponent {


  @ViewChild('31', { static: true }) myCanvas !: ElementRef;
  ...
  createThreeJsTrain(): void {
    ...
    var light1;
    var url = '../../../../../assets/blender/31.obj';
    var mtl = '../../../../../assets/blender/31.mtl';
    var mesh: THREE.MeshStandardMaterial;
    var valami: any;
    var controls: OrbitControls;

    const canvas = document.getElementById('31');
