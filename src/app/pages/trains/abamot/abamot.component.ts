...
@Component({
  selector: 'app-abamot',
  templateUrl: './abamot.component.html',
  styleUrls: ['./abamot.component.scss']
})
export class AbamotComponent {
  @ViewChild('abamot', { static: true }) myCanvas !: ElementRef;
  ...
  createThreeJsTrain(): void {
    ...
    var light1;
    var url = '../../../../../assets/blender/abamot.obj';
    var mtl = '../../../../../assets/blender/abamot.mtl';
    //var uv = new THREE.TextureLoader().load('../../../../../assets/blender/mk48.jpg');
    var mesh: THREE.MeshStandardMaterial;
    var valami: any;
    var controls: OrbitControls;

    const canvas = document.getElementById('abamot');
    ...
    function init() {
      ...
      meshLoaded.rotation.set(0, 20, 0);
      meshLoaded.position.set(-5, -4, 0);
