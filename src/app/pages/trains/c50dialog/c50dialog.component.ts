...
@Component({
  selector: 'app-c50dialog',
  templateUrl: './c50dialog.component.html',
  styleUrls: ['./c50dialog.component.scss']
})
export class C50dialogComponent {


  @ViewChild('c50', { static: true }) myCanvas !: ElementRef;
  ...
  createThreeJsTrain(): void {
    ...
    var light1;
    var url = '../../../../../assets/blender/c50.obj';
    var mtl = '../../../../../assets/blender/c50.mtl';
    var mesh: THREE.MeshStandardMaterial;
    var valami: any;
    var controls: OrbitControls;

    const canvas = document.getElementById('c50');
