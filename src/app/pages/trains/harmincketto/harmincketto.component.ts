...
@Component({
  selector: 'app-harmincketto',
  templateUrl: './harmincketto.component.html',
  styleUrls: ['./harmincketto.component.scss']
})
export class HarminckettoComponent {



  @ViewChild('32', { static: true }) myCanvas !: ElementRef;
  ...
  createThreeJsTrain(): void {
    ...
    var light1;
    var url = '../../../../../assets/blender/32.obj';
    var mtl = '../../../../../assets/blender/32.mtl';
    var mesh: THREE.MeshStandardMaterial;
    var valami: any;
    var controls: OrbitControls;

    const canvas = document.getElementById('32');
