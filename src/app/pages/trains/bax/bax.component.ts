...
@Component({
  selector: 'app-bax',
  templateUrl: './bax.component.html',
  styleUrls: ['./bax.component.scss']
})
export class BaxComponent {

  @ViewChild('bax', { static: true }) myCanvas !: ElementRef;
  ...
  createThreeJsTrain(): void {
    ...
    var light1;
    var url = '../../../../../assets/blender/bax.obj';
    var mtl = '../../../../../assets/blender/bax.mtl';
    var mesh: THREE.MeshStandardMaterial;
    var valami: any;
    var controls: OrbitControls;

    const canvas = document.getElementById('bax');
